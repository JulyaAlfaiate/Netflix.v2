...
export const movies: Movie[] = [
  ...
  },
  {
    id: 3,
    title: "Breaking Bad",
    description: "Um professor de química do ensino médio tornou-se fabricante de metanfetaminas em parceria com um ex-aluno para garantir o futuro financeiro de sua família.",
    imageUrl: "https://files.tecnoblog.net/wp-content/uploads/2022/06/breaking-bad.jpg",
    genre: "Crime, Drama, Thriller",
    year: 2008,
    seasons: 5,
    cast: "Bryan Cranston, Aaron Paul, Bob Odenkirk",
